...
export default function SocialLinks({ instagram, whatsapp, className = '' }: SocialLinksProps) {
  const baseClasses = "text-gray-400 hover:text-black transition-colors";
  const containerClass = `flex gap-4 ${className}`;
    ...
    <div className={containerClass}>
      {instagram && (
        <Link
          ...
          title="Instagram do Estúdio Caroá"
        >
      ...
      {whatsapp && (
        ...
        >
          <svg className="h-6 w-6" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor">
